  ...
  ...,"categories":categories[]->title
    ...
    return (
        <div>
            ...
            {loading ? (
                <div className="flex flex-col items-center justify-center py-10 min-h-80 gap-4 bg-gray-100 w-full mt-10 rounded-lg">
                    ...
                    <div className='grig grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2.5 mt-10'>
