            ...
            >
                ...
                <div className="text-center space-y-4">
                    ...
                    <p className="text-gray-600">
                        It looks loke you haven&apos;t added anything to your cart yet.
                        Let&apos;s change that and find something special!
                    </p>
                </div>
                ...
                <div>
                    <Link 
                        href="/"
                        className="block bg-darkColor/5 border border-darkColor/20 text-center py-2.5 rounded-lg text-darkColor font-semibold hover:bg-darkColor/10 transition"
                    >
                        Discover Products
                    </Link>
                </div>
