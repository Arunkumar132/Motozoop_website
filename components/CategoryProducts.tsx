...
import { client } from "@/sanity/lib/client";  // ✅ import client here
...
const CategoryProducts = ({ categories, slug }: Props) => {
  ...
  const fetchProducts = async (categorySlug: string) => {
    ...
    try {
      ...
      const data = await client.fetch(query, { categorySlug }); // ✅ client works now
      setProducts(data);
    } catch (error) {
  ...
  }, [currentSlug]); // ✅ depend on currentSlug, not router
